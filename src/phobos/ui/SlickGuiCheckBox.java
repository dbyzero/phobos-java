 ...
 * @author kevin
 */
public class SlickGuiCheckBox extends AbstractComponent {
	/** The default state */
	 ...
	 */
	public SlickGuiCheckBox(Image imageActive, Image imageInactive, int x, int y,boolean actif) {
		this(Engine.getInstance().getContainer(), new Rectangle(x, y, imageActive.getWidth(), imageActive.getHeight()));
		imgActive = imageActive ;
		imgInactive = imageInactive ;
		setActive(actif) ;
		updateImage();
	}
	 ...
	 */
	public SlickGuiCheckBox(GameContainer container, Shape shape) {
		super(container);
	...
	public void setActive(boolean act) {
		this.active = act ;
		if(this.active) {
			normalImage = imgActive ;
			currentImage = imgActive ;
			mouseOverImage = imgActive ;
			mouseDownImage = imgActive ;
		} else {
			normalImage = imgInactive ;
			currentImage = imgInactive ;
			mouseOverImage = imgInactive ;
			mouseDownImage = imgInactive ;
		}
	}
